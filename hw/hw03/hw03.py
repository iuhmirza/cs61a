...
def num_eights(pos):
    ...
    if pos < 10:
        ...
        return ((pos % 10 == 8) and 1) + num_eights(pos // 10)
...
def count_coins(change):
    ...
    True
    """
    def count_partitions(numberToPartition, maxPartSize):
        if numberToPartition == 0:
            return 1
        elif numberToPartition < 0:
            return 0
        elif maxPartSize == 0:
            return 0
        else:
            return count_partitions(numberToPartition - maxPartSize, maxPartSize) + count_partitions(numberToPartition, next_smaller_coin(maxPartSize))
