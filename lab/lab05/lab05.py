...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    romeBuiltInADay = make_city('rome', lat, lon)
    distanceToA = distance(romeBuiltInADay, city_a)
    distanceToB = distance(romeBuiltInADay, city_b)
...
def berry_finder(t):
    ...
    if label(t) == 'berry':
      ...
      return any(flatten([berry_finder(x) for x in branches(t)]))
